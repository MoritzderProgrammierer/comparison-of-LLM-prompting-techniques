...
class FewShotStrategy(PromptStrategy):
    def translate_to_german(self, model, text_to_translate: str) -> str:
        ...
        <example2>During the week, I always go to bed early. = Unter der Woche gehe ich immer früh schlafen.<endExample2>
    ...
    def translate_to_english(self, model, text_to_translate: str) -> str:
        ...
        <example2>Unter der Woche gehe ich immer früh schlafen. = During the week, I always go to bed early.<endExample2>
        Only return the translation:\n{text_to_translate}"
